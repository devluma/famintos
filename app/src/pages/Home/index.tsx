  ...
  <Container>
    ...
    <Content>
      <Section>
        ...
        <SectionArticle>
          <p>
            Os times da <b>DBserver</b> enfrentam um grande problema.
          </p>
          <p>
            Como eles são muito democráticos, todos os dias eles gastam 30 minutos decidindo onde
            eles irão almoçar.
          </p>
          <p>
            Registre uma opção de <b>Restaurante</b> para o seu <b>Time.</b>
          </p>
        </SectionArticle>
        <SectionFooter>
          <Link to="/signin">
