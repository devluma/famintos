...
import { Container, Content, Section, GraphContainer, ButtonGroup } from './styles';
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    api.get('/restaurants/list/by/points').then((response) => {
      const { data } = response;

      let dataWinner: IWinner = {
        name: 'Nenhum restaurante foi votado',
        attempts: 0,
      };
